...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug  6 22:08:12 2022
...
class Places365:
    def __init__(self):
        ...
        self.weight_softmax = params[-2].data.numpy()
    ...
    def pred(self, file_name):
        ...
        for i, v in enumerate(responses_attribute):
                result[self.labels_attribute[i].replace("/", " ").replace("_", " ").replace("-", " ")] = v
...
# places365 = Places365()   
# result = places365.pred("images/working_2.jpg")
# print(result)
